...
SessionManagementScreen {
    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        opacity: UsernameFieldOutlined ? 0.75 : 0.5
        horizontalAlignment: TextInput.Center
        text: lastUserName
        visible: showUsernamePrompt
        focus: showUsernamePrompt && !lastUserName //if there's a username prompt it gets focus first, otherwise password does
        placeholderText: config.UsernameFieldPlaceholderText == "Username" ? i18nd("plasma_lookandfeel_org.kde.lookandfeel", "Username") : config.UsernameFieldPlaceholderText
        textColor: "#ffffff"

        style: TextFieldStyle {
            textColor: UsernameFieldOutlined ? "#ffffff" : "#333333"
            placeholderTextColor: UsernameFieldOutlined ? "#ffffff" : "#333333"
            background: Rectangle {
                radius: 100
                border.color: "#ffffff"
                border.width: 1
                // color: UsernameFieldOutlined ? "transparent" : "#f1f1f1"
                color: "#333333"
                opacity: 0.25
            }
        }
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: passwordFieldOutlined ? "#ffffff" : "#333333"
            placeholderTextColor: passwordFieldOutlined ? "#ffffff" : "#333333"
            passwordCharacter: config.PasswordFieldCharacter == "" ? "●" : config.PasswordFieldCharacter
            background: Rectangle {
                radius: 100
                border.color: "#ffffff"
                border.width: 1
                // color: passwordFieldOutlined ? "transparent" : "#f1f1f1"
                color: "#333333"
                opacity: 0.25
            }
        }
